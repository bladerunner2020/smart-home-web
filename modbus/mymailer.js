...
var myClientID = '795895241053-jnacco3e77rrglfnh8unvajp5490ugar.apps.googleusercontent.com';
var myClientSecret = 'ty3kimJ3EAT3L1uQvT256yAS';
var myRefreshToken = '1/idmSLFddBgA-ImN5Gv0A2tuuK-TZkWqCdqqy08yMvJs';
var myAccessToken = '';
var myUser = 'pivovarov@gmail.com';
...
function sendMyData(subject, message) {
    ...
    transporter.verify(function(error, success) {
        if (error) {
            ...
            var mailOptions = {
                from: "pivovarov@gmail.com",
                to: "a.pivovarov@auvix.ru, pivovarov@gmail.com",
                subject: subject,
